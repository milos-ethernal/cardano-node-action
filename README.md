...
Sufix is optional parameter used in case that you need to append a value to the installed Cardano binaries, for example `cardano-node-11` and `cardano-cli-11`.
